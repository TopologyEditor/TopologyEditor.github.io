                    ...
                    <div className="row visual-menu">
                        <div className="col-xs-12">
                            <div className="col-xs-4">
                                <Button className="zoom-in glyphicon glyphicon-zoom-in" centered type="submit" bsSize="medium" bsStyle="primary" onClick={this.handleZoomIn}> Zoom in </Button>
                            </div>
                            <div className="col-xs-4">
                                <Button className="zoom-out glyphicon glyphicon-zoom-out" centered type="submit" bsSize="medium" bsStyle="primary" onClick={this.handleZoomOut}> Zoom out </Button>
                            </div>
                            <div className="col-xs-3">
                                <Button className="reset-view glyphicon glyphicon-refresh" centered type="submit" bsSize="medium" bsStyle="primary" onClick={this.handleReset}> Reset </Button>
                            </div>
                            <div className="col-xs-1">
                                <Button className="interactive-view glyphicon glyphicon-adjust" centered type="submit" bsSize="medium" bsStyle="primary" onClick={this.handleInteraction}></Button>
                            </div>
                        </div>
                    </div> <br />
                    <div className="row">
